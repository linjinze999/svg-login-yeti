<template>
  <div class='sly-login'>
    ...
    <div>
      ...
      <div class="input-box">
        <input type="text" id="loginEmail" maxlength="254" placeholder="账号" v-model="account"/>
      </div>
      <div class="input-box">
        <input type="password" id="loginPassword" placeholder="密码" v-model="password"/>
      </div>
      <div>
        <label id="showPasswordToggle" for="showPasswordCheck" class="password-show">
          <input id="showPasswordCheck" type="checkbox"/>显示密码
        </label>
      </div>
      <br/>
      <div>
...
<style scoped>
  ...
  .sly-login .login-box .svgContainer {
    position: relative;
    width: 200px;
    height: 200px;
    margin: 0 auto 1em;
  ...
  .sly-login .login-box .svgContainer div {
    position: relative;
    width: 100%;
    height: 0;
    overflow: hidden;
  ...
  .sly-login .login-box .svgContainer .mySVG {
    position: absolute;
    left: 0;
    top: 0;
    width: 100%;
  ...
  .sly-login .login-box .svgContainer:after {
    content: "";
    position: absolute;
    top: 0;
    left: 0;
  ...
  .sly-login .login-box .title {
    text-align: center;
  }

  .sly-login .login-box .input-box {
    width: 100%;
    padding: 2px;
    margin-bottom: 10px;
  }

  .sly-login .login-box .input-box input {
  ...
  .sly-login .login-box .input-box input:hover {
    border-color: #c0c4cc;
  }

  .sly-login .login-box .input-box input:focus {
    border-color: #409EFF;
  }

  .sly-login .login-box .password-show {
    color: #606266;
    cursor: pointer;
  }

  .sly-login .login-box .button-login {
    width: 100%;
    outline: 0;
    color: #ffffff;
    cursor: pointer;
  ...
  .sly-login .login-box .button-login:hover {
